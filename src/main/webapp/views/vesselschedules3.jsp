...
<html lang="en">
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background-color: #e3f2fd; color:black;">
            <a class='navbar-brand' href='./vesselschedules'>
            <img src="login/images/psa-logo.png" alt="PSA Logo" height="40px" width="70px">
            PORTNET 2.0
            <!-- <span class="navbar-brand mb-0 h1">PORTNET 2.0</span> -->
            </a>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="goFavoritePage()" >Favorites</a>
                </li>
                <li class="nav-item">
